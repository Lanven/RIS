...
INSERT INTO sb.orders_main 
	SELECT id, goods_id, client_id, on_sale_date, sale_amount, payment_method_id 
	FROM sb.orders;
...
INSERT INTO sb.orders_info 
	SELECT id, sale_type_id, details 
	FROM sb.orders;
